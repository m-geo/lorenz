...
colors = Symbol[]
# color_choices = [:red, :blue, :orange, :green, :orange, :purple, :yellow, :black, :brown, :lightblue, :lightgreen, :pink] # add more colors here for each partition
